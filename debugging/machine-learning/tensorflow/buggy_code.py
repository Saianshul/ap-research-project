...
training_dataset = training_dataset.shuffle(10000).batch(32).prefetch()
# training_dataset = training_dataset.shuffle(10000).batch(32).prefetch(tf.data.AUTOTUNE)
testing_dataset = testing_dataset.batch(32).prefetch()
...
model.fit(training_dataset, epochs=10, validation_data=testing_dataset)
